...
FileType.create("type_name"=>"VAR-OLPL")
FileType.create("type_name"=>"VCF-ANNOTATION")
GenomeReference.create("name" => "hg19", "build_name" => "NCBI build 37")
GenomeReference.create("name" => "hg18", "build_name" => "NCBI build 36")
