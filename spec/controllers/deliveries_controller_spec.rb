...
describe DeliveriesController do
  ...
  let(:valid_attributes) { { "sales_order" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved delivery as @delivery" do
        ...
        post :create, {:delivery => { "sales_order" => "invalid value" }}, valid_session
        assigns(:delivery).should be_a_new(Delivery)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested delivery" do
        ...
        Delivery.any_instance.should_receive(:update_attributes).with({ "sales_order" => "MyString" })
        put :update, {:id => delivery.to_param, :delivery => { "sales_order" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the delivery as @delivery" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Delivery.any_instance.stub(:save).and_return(false)
        put :update, {:id => delivery.to_param, :delivery => { "sales_order" => "invalid value" }}, valid_session
        assigns(:delivery).should eq(delivery)
      end
